...
TEST_F(DbnDecoderTests, TestParseMbo) {
  for (const auto path : {TEST_BUILD_DIR "/data/test_data.mbo.dbn",
    ...
    EXPECT_EQ(ch_metadata.start.time_since_epoch().count(),
              1609160400000000000);
...
TEST_F(DbnDecoderTests, TestParseMbp1) {
  for (const auto path : {TEST_BUILD_DIR "/data/test_data.mbp-1.dbn",
                          TEST_BUILD_DIR "/data/test_data.mbp-1.dbn.zst"}) {
...
TEST_F(DbnDecoderTests, TestParseMbp10) {
  for (const auto path : {TEST_BUILD_DIR "/data/test_data.mbp-10.dbn",
                          TEST_BUILD_DIR "/data/test_data.mbp-10.dbn.zst"}) {
    this->ReadFromFile(path);
...
TEST_F(DbnDecoderTests, TestParseTbbo) {
  for (const auto path : {TEST_BUILD_DIR "/data/test_data.tbbo.dbn",
...
TEST_F(DbnDecoderTests, TestParseTrades) {
  for (const auto path : {TEST_BUILD_DIR "/data/test_data.trades.dbn",
                          TEST_BUILD_DIR "/data/test_data.trades.dbn.zst"}) {
    this->ReadFromFile(path);
...
TEST_F(DbnDecoderTests, TestParseOhlcv1D) {
  for (const auto path : {TEST_BUILD_DIR "/data/test_data.ohlcv-1d.dbn",
                          TEST_BUILD_DIR "/data/test_data.ohlcv-1d.dbn.zst"}) {
    this->ReadFromFile(path);
...
TEST_F(DbnDecoderTests, TestParseOhlcv1H) {
  for (const auto path : {TEST_BUILD_DIR "/data/test_data.ohlcv-1h.dbn",
                          TEST_BUILD_DIR "/data/test_data.ohlcv-1h.dbn.zst"}) {
    this->ReadFromFile(path);
...
TEST_F(DbnDecoderTests, TestParseOhlcv1M) {
  for (const auto path : {TEST_BUILD_DIR "/data/test_data.ohlcv-1m.dbn",
                          TEST_BUILD_DIR "/data/test_data.ohlcv-1m.dbn.zst"}) {
    this->ReadFromFile(path);
...
TEST_F(DbnDecoderTests, TestParseOhlcv1S) {
  for (const auto path : {TEST_BUILD_DIR "/data/test_data.ohlcv-1s.dbn",
                          TEST_BUILD_DIR "/data/test_data.ohlcv-1s.dbn.zst"}) {
    this->ReadFromFile(path);
...
TEST_F(DbnDecoderTests, TestParseDefinition) {
  for (const auto path :
       {TEST_BUILD_DIR "/data/test_data.definition.dbn",
        TEST_BUILD_DIR "/data/test_data.definition.dbn.zst"}) {
    this->ReadFromFile(path);
